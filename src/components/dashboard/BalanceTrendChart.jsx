...
export const BalanceTrendChart = () => {
    ...
    const data = useMemo(() => {
        ...
        Object.keys(grouped)
            ...
            .forEach(date => {
                ...
                // Fix timezone parsing consistency by splitting
    ...
    return (
        ...
        >
            <h3 className="text-[18px] font-bold text-slate-800 dark:text-white absolute top-6 tracking-wide transition-colors duration-300">Finances</h3>
            {data.length === 0 ? (
